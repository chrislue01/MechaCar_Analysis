...
library(tidyverse)
mecha_mpg <- read.csv(file='Desktop/R-Annylisis/Resources/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F) 
...
mecha_coil <- read.csv(file='Desktop/R-Annylisis/Resources/Suspension_Coil.csv',check.names=F,stringsAsFactors = F) 
